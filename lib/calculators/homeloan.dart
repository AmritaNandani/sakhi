...
class AppTheme {
  ...
  static const Color brownColor = Color(0xFF795548); // Brown for Home Loan
}
...
class PieChartPainter extends CustomPainter {
  final double investedAmount; // Principal
  final double totalInterest; // Interest
...
class HomeLoanEMICalculatorPage extends StatefulWidget {
  const HomeLoanEMICalculatorPage({super.key});

  @override
  State<HomeLoanEMICalculatorPage> createState() => _HomeLoanEMICalculatorPageState();
}

class _HomeLoanEMICalculatorPageState extends State<HomeLoanEMICalculatorPage> {
  double _loanAmount = 100000.0;
  ...
  Widget build(BuildContext context) {
    int tenureDivisions = _isYearsSelected ? 29 : 359;
    double tenureMax = _isYearsSelected ? 30.0 : 360.0;
            ...
            child: ElevatedButton(
              onPressed: () {
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(
                    content: const Text('Download Lxme App functionality coming soon!'),
                    backgroundColor: AppTheme.primaryColor,
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      buildSliderInput(
                                        ...
                                        min: 100000,
                                        max: 10000000,
                                        divisions: (10000000 - 100000) ~/ 100000 + 1,
                                        onChanged: (value) {
                                          setState(() {
                                            _loanAmount = value;
                                          });
                                      ...
                                      buildSliderInput(
                                        ...
                                        maxValueLabel: _isYearsSelected ? '30 Years' : '360 Months',
                                      ),
                                    ],
                                  ),
                                ),
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: () {
                    ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(
                        content: const Text('Download Sakhi App functionality coming soon!'),
                        backgroundColor: AppTheme.primaryColor,
                        behavior: SnackBarBehavior.floating,
                        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(10)),
                        margin: const EdgeInsets.all(10),
